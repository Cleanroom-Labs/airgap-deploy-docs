...
+-------------------------------------+-----------------------------+--------------+--------------------------------------+
| Include ALSA packages (Linux)       | ``SystemPackageComponent``  | |partial|    | Exists but not in example            |
+-------------------------------------+-----------------------------+--------------+--------------------------------------+
| Multi-platform packages             | Platform abstraction        | |deferred|   | Cross-compilation in v0.2            |
+-------------------------------------+-----------------------------+--------------+--------------------------------------+
...
.. |partial| replace:: ⚠️ Partial
.. |deferred| replace:: ⚠️ Deferred
.. |gap| replace:: ❌ **Gap**
.. |unclear| replace:: ⚠️ Unclear
